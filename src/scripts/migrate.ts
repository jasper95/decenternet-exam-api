...
import QueryWrapper, { SchemaBuilder } from 'utils/dbwrapper'
...
import { getMongoDBConnectionString, createProxy } from 'utils/tools'
...
export default async function migrateMain() {
  ...
  const schema_builder = new SchemaBuilder(schema, DB)
  // await dropViews()
